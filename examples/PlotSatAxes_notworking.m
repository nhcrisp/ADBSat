%This is an older file from David's implementation, that could be changed in order to plot any provided geometry file 
  %and plot the axes, so that users can check that the orientation is correct before they try and use it.
